                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="#">Aguardiente</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="text-muted">Precio: $115.99</span>
...
<script>
    $(document).ready(function(){
        $('.dropdown-item').click(function(){
            ...
            // Supongamos que `isLoggedIn` es una variable que indica si el usuario ha iniciado sesión
            var isLoggedIn = false; // Cambia esto a true si el usuario ha iniciado sesión
            if (!isLoggedIn) {
                // Mostrar el anuncio si el usuario no ha iniciado sesión
                alert('Debes iniciar sesión para ver todos nuestros productos');
                // Detener el comportamiento predeterminado de los enlaces
                return false;
            }
        });
    });
...
<script>
    $(document).ready(function(){
        $('.text-reset').click(function(event){
            // Verificar si el usuario ha iniciado sesión
            // Aquí debes agregar la lógica para determinar si el usuario ha iniciado sesión o no
            var isLoggedIn = false; // Cambia esto a true si el usuario ha iniciado sesión
            if (!isLoggedIn) {
                // Mostrar el mensaje si el usuario no ha iniciado sesión
                alert('Para ver todos nuestros productos debes iniciar sesión');
