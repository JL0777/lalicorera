...
<body>
    ...
    <div class="text-center">
        <img src="https://static.vecteezy.com/system/resources/previews/014/070/874/non_2x/beer-party-banner-with-bottles-and-glass-free-vector.jpg" class="img-fluid" alt="Descripción de la imagen">
...
<section class="py-5">
    <div class="container">
        <h2 class="text-center mb-5">Cerveza</h2>

        <div class="row">
            <!-- Product 1 -->
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="https://drinkx.com.co/wp-content/uploads/2021/07/cerveza-coronita-extra-botella-six-pack-210-ml.jpg" class="card-img-top" alt="Producto 1">
                    <div class="card-body">
                        <h5 class="card-title">PACK CORONA X 6</h5>
                        <p class="card-text">Cerveza.</p>
                    </div>
                    <div class="card-footer">
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="text-muted">Precio: $30.000</span>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="https://vaquitaexpress.com.co/media/catalog/product/cache/e89ece728e3939ca368b457071d3c0be/7/7/7702004007377_4.jpg" class="card-img-top" alt="Producto 2">
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="text-muted">Precio: $22.800</span>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="https://piragua.com.co/wp-content/uploads/2019/11/aguila-original-sixpack.jpg" class="card-img-top" alt="Producto 3">
                    <div class="card-body">
                        <h5 class="card-title">PACK AGUILA X 6</h5>
                        <p class="card-text">Cerveza.</p>
                    </div>
                    <div class="card-footer">
                        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="https://piragua.com.co/wp-content/uploads/2019/11/aguila-lightl-sixpack.jpg" class="card-img-top" alt="Producto 1">
                    <div class="card-body">
                        <h5 class="card-title">PACK AGUILA LIGHT X 6</h5>
                        <p class="card-text">Cerveza.</p>
                    </div>
                    <div class="card-footer">
                        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="https://i.pinimg.com/736x/a1/53/c5/a153c568438e8308ac221b590a9a9a42.jpg" class="card-img-top" alt="Producto 2">
                    <div class="card-body">
                        <h5 class="card-title">PACK TECATE X 6</h5>
                        <p class="card-text">Cerveza.</p>
                    </div>
                    <div class="card-footer">
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="text-muted">Precio: $18.000</span>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="https://piragua.com.co/wp-content/uploads/2019/11/redds-sixpack-piragua.jpg" class="card-img-top" alt="Producto 3">
                    <div class="card-body">
                        <h5 class="card-title">PACK REDS X 6</h5>
                        <p class="card-text">Cerveza.</p>
                    </div>
                    <div class="card-footer">
                        <div class="d-flex justify-content-between align-items-center">
